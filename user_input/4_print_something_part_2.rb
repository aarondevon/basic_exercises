=begin
n the previous exercise, you wrote a program that asks the user if they want the program to print "something". However, this program recognized any input as valid: if you answered anything but y, it treated it as an n response, and quit without printing anything.
...
puts ">> Would you like to pint something? y or n"
...
loop do
  ...
  if input == 'y'
    ...
    puts '>> Sorry, that is not a valid input. Please enter y or n'
  end
end
